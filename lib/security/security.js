 ...
 * @returns {string}
 */
function generateSHA256withRSAHeaderV3(url, params, method, strContentType, appId, keyCertContent, keyCertPassphrase, realm) {
  var nonceValue = nonce();
  var timestamp = (new Date).getTime();
...
security.generateAuthorizationHeader = function(url, params, method, strContentType, authType, appId, keyCertContent, passphrase, realm) {
  ...
  else if(authType == "L2v3"){
    return generateSHA256withRSAHeaderV3(url, params, method, strContentType, appId, keyCertContent, passphrase, realm);
  }
  else {
    return "";
  }
